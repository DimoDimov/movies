...
describe('getApiMovies initial', function() {
    beforeEach(function() {
...
//testing the middleware logic
//second page loading
describe('getApiMovies load second page', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();
...
describe('getApiMovies with filter phrase', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();
...
describe('getApiMovies with filter phrase when no movies found', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();
...
//testing the middleware logic
//when wrong data for list and page is inputed
//load the initial first page with 20 movies
//I would display initial results rather to throw exceptions
//It strongly dependes on documentation how to proceed in this case
describe('getApiMovies initial even when wrong list and page format received', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();

        req.query.list = "wrong";
        req.query.page = "wrong";
        req.query.q = "";
...
//list and page are out of the DB boundries. 
//I will display results rather than to throw exception
describe('getApiMovies initial even when list and page requesting number which is outside the boundries', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();

        //we do not have so many records
        //but we will display results
        //in some case we would return an error
        //as we dont have documentation we will silently handle the error
        //and display initial page
        req.query.list = 180000;
        req.query.page = 180000;
        req.query.q = "";
...
//list and page are out of the DB boundries. 
//I will display results rather than to throw exception
describe('getApiMovies initial even when list and/or page numbers are negative', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();
...
//list and page are out of the DB boundries. 
//I will display results rather than to throw exception
describe('getApiMovies initial even when list and/or page and/or query are undefined', function() {
    beforeEach(function() {
        req = httpMocks.createRequest();
        res = httpMocks.createResponse();
