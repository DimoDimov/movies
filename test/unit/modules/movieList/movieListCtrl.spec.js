...
describe("movieListCtrl", function () {
	...
	describe("Method Testing", function () {
		...
		// it("Should successfully update the scope on proccessMovies getAllMoviesSuccess", function () {
		// 	//set final page for testing
		// 	$scope.finalPage = 5;
...
// //Should trace the data handling by movieModelService
// describe("Should trace the data handling by movieModelService", function() {
//     var movieAPIServicesSpy,
//         deferred,
...
//             deferred.resolve(APIServiceResult);
//         });
//     });
