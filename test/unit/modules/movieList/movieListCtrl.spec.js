...
describe("Should trace the data handling by movieModelService within movieListCtrl", function() {
	...
	it("Should display error when recieved", function() {
    	...
    	expect($scope.movieList.length).toBe(20);
     	expect(controller.getAllMoviesSuccess).toBeDefined();

        var	wrongHttpResponse = {"movies":[],"errorMessage":"No matching items","totalfilteredMovies":0,"totalMoviesCount":160};

     	controller.getAllMoviesSuccess(wrongHttpResponse);
    ...
    // describe("Should handle error messages", function() {
    ...
    // describe("Should test search phrase", function() {
    // 	var movieModelServicesSpy,
    // 		movieModelServices;
    ...
    // 	beforeEach(function() {
	   ...
	   //              .respond(200, httpResponse);
				...
				// // $httpBackend.when('GET', '/api/movies?list=20&page=1&q=wee')
