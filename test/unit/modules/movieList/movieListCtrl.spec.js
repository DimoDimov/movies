...
describe("Should trace the data handling by movieModelService within movieListCtrl", function() {
    ...
    it("Should reject result in movieModelServices", function() {
     	$rootScope.$digest();
	...
	it("Should try to set list to non numeric value but handle it", function() {
     	$rootScope.$digest();

        $scope.list = "non numeric value";

        $rootScope.$digest();
    	expect($scope.list).toBe(20);
    });

    it("Should try to set currentPage to non numeric value but handle it", function() {
     	$rootScope.$digest();

        $scope.currentPage = "non numeric value";

        $rootScope.$digest();
    	expect($scope.currentPage).toBe(1);
    });

    it("Should try to set currentPage after the final page", function() {
     	$rootScope.$digest();
    ...
    it("Should update list if search phrase", function() {
     	$rootScope.$digest();
        ...
        $scope.searchPhrase = "week";

        $rootScope.$digest();
        expect($scope.list).toBe(2);
        expect($scope.currentPage).toBe(1);

        //force to represent the problem
        $scope.list = 20;
        $rootScope.$digest();
        expect($scope.list).toBe(2);
    });
