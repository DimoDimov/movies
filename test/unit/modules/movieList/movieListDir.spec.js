...
describe("movieListDir", function() {
    ...
    beforeEach(function() {
        ...
        inject(function($injector) {
            ...
            movieModelServicesSpy = spyOnAngularService($injector.get('movieModelServices'), 'getAllMovies', deferred);
    ...
    describe("Display Messages", function () {
        ...
        //         $rootScope = $injector.get('$rootScope');
        //         $scope = $rootScope.$new();
        //          //movieModelServicesSpy = jasmine.createSpyObj('authService', ['login', 'logout', 'currentUser']);
        //         changeSpyReturnErr(movieModelServicesSpy, {"movies":[],"errorMessage":"No matching items","totalfilteredMovies":0,"totalMoviesCount":0});
